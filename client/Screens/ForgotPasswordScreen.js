...
const ForgotPasswordScreen = () => {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            const res = await axios.post('http://10.0.2.2:3000/api/auth/ForgotPassword', user);
            setEmail('');
            setIsSending(false);
            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.innerContainer}>
                        ...
                        <TouchableOpacity style={styles.button} onPress={handleForgotPassword} disabled={isSending}>
                            <LinearGradient
